 ...
 * 
 */
@WebServiceClient(name = "WS_Pedidos", targetNamespace = "http://dominio/", wsdlLocation = "http://localhost:8080/WS_Pedidos/WS_Pedidos?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WSPEDIDOS_QNAME = new QName("http://dominio/", "WS_Pedidos");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WS_Pedidos/WS_Pedidos?wsdl");
     ...
     *     returns WSPedidos
     */
    @WebEndpoint(name = "WS_PedidosPort")
    public WSPedidos getWSPedidosPort() {
        return super.getPort(new QName("http://dominio/", "WS_PedidosPort"), WSPedidos.class);
    }
    ...
    public WSPedidos getWSPedidosPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://dominio/", "WS_PedidosPort"), WSPedidos.class, features);
    }
