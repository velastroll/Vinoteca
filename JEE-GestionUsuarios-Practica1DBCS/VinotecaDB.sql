...
('a','del anno'), ('c','crianza'), ('g','gran reserva'), ('r','reserva');

CREATE TABLE "DENOMINACION_ORIGEN" ( 
"DO_ID" INTEGER NOT NULL primary key GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1),
"NOMBRE" VARCHAR(20) default NULL
);

INSERT INTO denominacion_origen (nombre) VALUES
('Ribera'), ('Rioja'), ('Rueda'), ('Cigales');
...
CONSTRAINT EM_FK FOREIGN KEY (EM_NIF) REFERENCES PERSONA (NIF)
);
...
"AB_NIF" VARCHAR(9) not NULL,
"AB_PASSWD" VARCHAR(8) DEFAULT NULL, 
CONSTRAINT AB_FK FOREIGN KEY (AB_NIF) REFERENCES PERSONA (NIF)
);
...
CONSTRAINT PR_FK1 FOREIGN KEY (NIFABONADO) REFERENCES abonado (ab_NIF),
CONSTRAINT PR_FK2 FOREIGN KEY (IDDENOMINACION) REFERENCES DENOMINACION_ORIGEN (DO_ID), 
CONSTRAINT PR_FK3 FOREIGN KEY (CATEGORIA) REFERENCES CATEGORIA (CLAVE) 
);
...
"IDDENOMINACION" INTEGER NOT NULL, 
"CATEGORIA" CHAR not NULL,
CONSTRAINT VI_FK1 FOREIGN KEY (IDBODEGA) REFERENCES BODEGA (ID),
CONSTRAINT VI_FK2 FOREIGN KEY (IDDENOMINACION) REFERENCES DENOMINACION_ORIGEN (DO_ID), 
CONSTRAINT VI_FK3 FOREIGN KEY (CATEGORIA) REFERENCES CATEGORIA (CLAVE) 
);

INSERT INTO VINO (NOMBRECOMERCIAL,COMENTARIO,IDBODEGA,IDDENOMINACION,CATEGORIA) VALUES 
('Nombre21','buena relacion calidad-precio',2,3,'a'),
('Nombre22','un poco caro, pero buena calidad',2,3,'c'),
('Nombre3','comentario a nombre 3',1,1,'g'),
('Nombre4','comentario a nombre4',1,4,'c'), 
('Nombre5','comentario a nombre5',3,2,'r');
...
CONSTRAINT RE_FK1 FOREIGN KEY (VINOID) REFERENCES VINO (ID) 
);
...
CREATE TABLE "PEDIDO" (
"PE_ID" INTEGER NOT NULL primary key GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1), 
"PE_ESTADO" CHAR NOT NULL, 
"IMPORTE" REAL DEFAULT NULL, 
"FECHA" VARCHAR(20) default NULL, 
"PE_NIF" VARCHAR(9) not NULL, 
"PE_REFERENCIA" INTEGER NOT NULL, 
CONSTRAINT PE_FK1 FOREIGN KEY (PE_NIF) REFERENCES abonado (ab_NIF), 
CONSTRAINT PE_FK2 FOREIGN KEY (PE_REFERENCIA) REFERENCES REFERENCIA (CODIGO), 
CONSTRAINT PE_FK3 FOREIGN KEY (PE_ESTADO) REFERENCES ESTADO_PEDIDO (EP_CLAVE) 
);
